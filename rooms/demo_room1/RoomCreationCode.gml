...
list1.min_width = 170;
list1.justify_content = UI_JUSTIFY_CONTENT.FILL_WIDTH;
...
list2.justify_content = UI_JUSTIFY_CONTENT.FILL_WIDTH;
...
textbox4 = instance_create_depth(0, 0, depth, obj_gm_ui_textbox);
textbox4.set_margin(5);
textbox4.text_content = "Here are some more demo rooms:";

button5 = instance_create_depth(0, 0, depth, obj_gm_ui_button_primary);
button5.text_content = "See Demo for 'Justify Content'";
button5.add_event_callback(UI_EVENT.ON_MOUSE_RELEASED, function() {
